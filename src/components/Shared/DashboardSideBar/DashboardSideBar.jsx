      ...
      <ul className="space-y-2">
        {dashboardRouteList.map((route) => (
          <li
            ...
            >
            <NavLink exact={route.pathUrl === '/dashboard'} activeClassName="text-blue-500 font-semibold bg-slate-100" href={route.pathUrl} className="flex gap-2 items-center cursor-pointer lg:px-2 xl:px-3 py-2 rounded hover:bg-slate-100 ">
