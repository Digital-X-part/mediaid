...
const RelatedProducts = () => {
  ...
  return (
    <>
      <div className="border rounded-xl shadow-md shadow-indigo-200 md:mx-auto mx-2 md:my-6 my-4  px-4 py-4  ">
        <h2 className="font-bold mb-6 text-xl md:text-2xl  rounded-2xl border  border-indigo-200 p-2 ">
          Related Products
        </h2>
